...
function getNextUnassigned(board) {
    ...
    return unassigned.sort((a, b) => a.availableNumbersCount - b.availableNumbersCount);
}
...
function solveSudokuByBackTrackingWithMRV(squares) {
    backTrackingWithMRV(squares);
    return squares;
}

export default solveSudokuByBackTrackingWithMRV;