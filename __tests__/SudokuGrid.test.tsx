...
describe('SudokuGrid Component', () => {
  const mockGrid: GridType = Array(9)
    .fill(null)
    .map(() => Array(9).fill(null));
  const mockPossibleValues = Array(9)
    .fill(null)
    .map(() => Array(9).fill(null));
  const mockConflicts = Array(9)
    .fill(null)
  ...
  test('handles grid with values', () => {
    const gridWithValues: GridType = Array(9)
      .fill(null)
      .map(() => Array(9).fill(null));
  ...
  test('handles possible values display', () => {
    const possibleValuesWithData = Array(9)
      .fill(null)
      .map(() => Array(9).fill(null));
  ...
  test('handles conflicts display', () => {
    const conflictsWithError = Array(9)
      .fill(null)
      .map(() => Array(9).fill(false));
  ...
  test('calls onCellChange when prop exists', () => {
    ...
    render(<SudokuGrid {...defaultProps} onCellChange={mockOnCellChange} />);
  ...
  test('handles single possibility highlighting', () => {
    const possibleValuesWithSingle = Array(9)
      .fill(null)
      .map(() => Array(9).fill(null));
  ...
  test('handles edge cases gracefully', () => {
    const possibleValuesWithNull = Array(9)
      .fill(null)
      .map(() => Array(9).fill(null));
  ...
  describe('User Input Handling', () => {
    ...
    test('handles clearing cell input', () => {
      const mockOnCellChange = jest.fn();
      const gridWithValue: GridType = Array(9)
        .fill(null)
        .map(() => Array(9).fill(null));
      gridWithValue[0][0] = 5;
    ...
    test('handles input in non-custom mode with given values', () => {
      const initialGrid: GridType = Array(9)
        .fill(null)
        .map(() => Array(9).fill(null));
  ...
  describe('Cell Styling and Conflicts', () => {
    test('displays conflict styling for cells with conflicts and values', () => {
      const gridWithConflict: GridType = Array(9)
        .fill(null)
        .map(() => Array(9).fill(null));
    ...
    test('displays multiple possible values correctly', () => {
      const possibleValuesWithMultiple = Array(9)
        .fill(null)
        .map(() => Array(9).fill(null));
  ...
  describe('Possible Values Rendering', () => {
    ...
    test('does not render possible values for cells with values', () => {
      ...
      const possibleValuesGrid =
        firstCellContainer?.querySelector('.grid-cols-3');
